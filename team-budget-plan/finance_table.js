...
var myData = [
    {"dealId" : 0, "project_cost" : 1000},
    {"dealId" : 1, "project_cost" : 10000},
    {"dealId" : 2, "project_cost" : 100000}
]
...
function AddNewDeal() {
    ...
    InsertRow(currentDealId, projectCost);
    

}

function InsertRow(dealId, projectCost) {
    myData.push({"dealId": dealId, "project_cost" : projectCost})
    currentDealId++;
    CreateTableFromJSON();
...
//function DeleteDeal(){
//    var dealId = document.getElementById("idToDelete").value;
